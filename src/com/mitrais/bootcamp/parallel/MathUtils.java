...
public class MathUtils {
    ...
    public static Double arraySumParallel(Double[] nums) {
        ...
        ParallelArrayProcessor<Double, Double> processor = new ParallelArrayProcessor<>(
                nums,
                parallelSizeCutoff,
                smallSizeProcessor,
                valueCombiner,
    ...
    public static double smallestTransformedValue(Double[] nums,
    ...
    private MathUtils() {
    } // Uninstantiatable class: only static methods
}
